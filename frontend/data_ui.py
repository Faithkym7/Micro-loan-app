...
from backend.data_logic import process_uploaded_file
    ...
    with st.container(border=True, height=650, width="stretch"):
        ...
        with tabs[0]:
            ...
            st.text(
                ...
                "Please upload both of the following documents to proceed:"
            )
        ...
        with tabs[1]:
            ...
            st.text(
                ...
                "Upload all the following financial statements:"
            )
        ...
        with tabs[2]:
            ...
            st.text(
                ...
                "Upload your owner's equity or capital document:"
            )
            files["equity_doc"] = st.file_uploader("Owner’s Equity Document", type=["csv"], key="equity_doc")
        ...
        with tabs[3]:
            ...
            st.session_state["liquidation_value"] = st.slider("Liquidation value (1–5)", 1, 5, 1)
        ...
        # --- Process uploads (run once any file is uploaded) ---
